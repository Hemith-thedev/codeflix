      ...
      <section className="hero-section relative">
        ...
        <div className="wrapper relative">
          <div className="flex flex-col justify-center items-center h-full w-full">
            <h2 className="logo font-normal!">
              {"<"}
              <span className="gradient-text">Codeflix</span> {"/>"}
            </h2>
            <h3 className="text-center">
              Stop{" "}
              <span className="text-primary-500 mix-blend-plus-lighter">
                watching
              </span>
              , start{" "}
              <span className="text-secondary-500 mix-blend-plus-lighter">
                compiling
              </span>
              !
            </h3>
